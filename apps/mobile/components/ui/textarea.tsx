...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        'text-foreground border-input dark:bg-input/30 flex min-h-16 w-full flex-row rounded-md border bg-transparent px-3 py-2 font-callout shadow-sm shadow-black/5 md:font-footnote',
        Platform.select({
