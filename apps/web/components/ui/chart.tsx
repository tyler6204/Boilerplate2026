...
type TooltipProps = {
  ...
  label?: string | number
  labelFormatter?: (value: string | number | undefined, payload: TooltipPayload[]) => ReactNode
  formatter?: (value: number | string, name: string, item: TooltipPayload, index: number, payload: Record<string, unknown>) => ReactNode
}
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value && (
                        <span className="text-foreground-secondary font-mono font-medium tabular-nums">
