          ...
          <div className="mt-8 flow-root">
            <div className="-my-6 divide-y divide-border">
              <div className="space-y-1 py-6">
                {NAV_LINKS.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="-mx-3 block rounded-lg px-3 py-3 text-base font-medium text-foreground/80 hover:bg-accent"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    {link.label}
                  </Link>
              ...
              <div className="py-6 space-y-3">
                <Link
                  href="/login"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-medium text-foreground/80 hover:bg-accent"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Sign in
                </Link>
