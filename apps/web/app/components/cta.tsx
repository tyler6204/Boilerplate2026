    ...
    <section id="cta" className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Link href="#" className="inline-flex items-center gap-3">
                ...
                <span className="flex flex-col items-start">
                  <span className="font-caption font-normal opacity-80">Download on the</span>
                  <span className="font-footnote font-semibold">App Store</span>
                </span>
              </Link>
            </Button>
            ...
            >
              <Link href="#" className="inline-flex items-center gap-3">
                ...
                <span className="flex flex-col items-start">
                  <span className="font-caption font-normal opacity-80">Get it on</span>
                  <span className="font-footnote font-semibold">Google Play</span>
                </span>
              </Link>
            </Button>
          </div>
          ...
          {/* Trust signals */}
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 font-footnote text-foreground/50">
